...
namespace TfsWorkbench.ReportViewer.ReportService2008 {
    using System;
    ...
    public partial class ReportingService2005 : System.Web.Services.Protocols.SoapHttpClientProtocol, IReportWebService {
        ...
        public ReportingService2005() {
            this.Url = global::TfsWorkbench.ReportViewer.Properties.Settings.Default.TfsWorkbench_ReportsService_ReportWebService_ReportingService2005;
        ...
        public CatalogItemBase[] ListBaseChildren(string path, bool recursive)
        {
            return ListChildren(path, recursive);
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://schemas.microsoft.com/sqlserver/2005/06/30/reporting/reportingservices")]
    public partial class CatalogItem : CatalogItemBase {
        ...
        public override bool IsReport
        {
            get
            {
                return this.Type == ItemTypeEnum.Report;
            }
        }
