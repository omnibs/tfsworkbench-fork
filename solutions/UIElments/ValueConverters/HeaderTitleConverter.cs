// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HeaderTitleConverter.cs" company="None">
//   None
// </copyright>
// <summary>
//   Defines the HeaderTitleConverter type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace TfsWorkbench.UIElements.ValueConverters
{
    ...
    /// <summary>
    /// The header title converter
    /// </summary>
    public class HeaderTitleConverter : IMultiValueConverter
    {
        /// <summary>
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var workbenchItem = values[1] as IWorkbenchItem;

            if (workbenchItem == null || workbenchItem.ValueProvider == null)
            {
                return string.Empty;
            }

            return string.Format(
                CultureInfo.InvariantCulture, "({0}) {1}", workbenchItem.GetId(), workbenchItem.GetCaption());
        }
