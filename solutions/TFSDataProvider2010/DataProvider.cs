...
using TfsWorkbench.TFSDataProvider2010.Helpers;
using TfsWorkbench.TFSDataProvider2010.Properties;

namespace TfsWorkbench.TFSDataProvider2010
{
    /// <summary>
    ...
    internal class DataProvider : ProjectDataServiceConsumer, IDataProvider
    {
        ...
        public object GetWorkItemEditPanel(IWorkbenchItem workbenchItem)
        {
            ...
            return WorkItemEditor2010.Factory.BuildWorkItemEditPanel(provider.WorkItem);
        }
